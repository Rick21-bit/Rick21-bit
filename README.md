...
|--------|-------------|
| [c-linked-list](https://github.com/Rick21-bit/c-linked-list) | linked list with tests |
| [c-hash-table](https://github.com/Rick21-bit/c-hash-table) | chaining hash table |
| [c-file-indexer](https://github.com/Rick21-bit/c-file-indexer) | directory file indexer |
| [c-json-lexer](https://github.com/Rick21-bit/c-json-lexer) | JSON tokenizer |
| [c-thread-pool](https://github.com/Rick21-bit/c-thread-pool) | POSIX thread pool |
| [c-memory-arena](https://github.com/Rick21-bit/c-memory-arena) | arena allocator |
| [c-log-parser](https://github.com/Rick21-bit/c-log-parser) | structured log parser |
| [c-http-server](https://github.com/Rick21-bit/c-http-server) | minimal HTTP server |
| [c-network-utils](https://github.com/Rick21-bit/c-network-utils) | hostname resolution helpers |
| [c-unit-test-framework](https://github.com/Rick21-bit/c-unit-test-framework) | tiny test macros |
| [c-event-loop](https://github.com/Rick21-bit/c-event-loop) | cooperative loop |
| [c-bitmap-editor](https://github.com/Rick21-bit/c-bitmap-editor) | grayscale bitmap structure |

## TypeScript / Express REST APIs

| project | what it does |
|--------|-------------|
| [ts-task-api](https://github.com/Rick21-bit/ts-task-api) | task management API |
| [ts-url-api](https://github.com/Rick21-bit/ts-url-api) | URL shortener API |
| [ts-blog-api](https://github.com/Rick21-bit/ts-blog-api) | blog posts API |
| [ts-auth-api](https://github.com/Rick21-bit/ts-auth-api) | users and auth API |
| [ts-order-api](https://github.com/Rick21-bit/ts-order-api) | e-commerce order API |
| [ts-chat-api](https://github.com/Rick21-bit/ts-chat-api) | chat messages API |

## 2021 projects

| project | what it does |
|--------|-------------|
| [advancephp](https://github.com/Rick21-bit/advancephp) | php oop practice |
| [learningjs-pokergame](https://github.com/Rick21-bit/learningjs-pokergame) | vanilla js poker game |
| [braintech-2021](https://github.com/Rick21-bit/braintech-2021) | blog platform with ai helper |
| [youjs](https://github.com/Rick21-bit/youjs) | youtube clone in js |
| [seecorona](https://github.com/Rick21-bit/seecorona) | covid 19 heatmap |
| [stayaway](https://github.com/Rick21-bit/stayaway) | covid 19 info page |
| [ethacker](https://github.com/Rick21-bit/ethacker) | sql injection demo |
| [playingchess](https://github.com/Rick21-bit/playingchess) | chess learning site |

## 2022 projects

| project | what it does |
|--------|-------------|
| [gamerzone](https://github.com/Rick21-bit/gamerzone) | game portal landing |
| [whereismymoney](https://github.com/Rick21-bit/whereismymoney) | mini finance tracker |
| [musclebuldier](https://github.com/Rick21-bit/musclebuldier) | workout plans ui |
| [fifa22-combo](https://github.com/Rick21-bit/fifa22-combo) | fifa combo explorer |
| [gymzone](https://github.com/Rick21-bit/gymzone) | gym landing page |
| [cleancode](https://github.com/Rick21-bit/cleancode) | clean code notes |
| [trackingalgo](https://github.com/Rick21-bit/trackingalgo) | algorithm practice |
| [codepen-clones](https://github.com/Rick21-bit/codepen-clones) | recreated codepen ideas |
| [i3-next-experimental](https://github.com/Rick21-bit/i3-next-experimental) | experimental linux ui |
| [amero-2022](https://github.com/Rick21-bit/amero-2022) | small crypto project |
| [flutter-simplecounter](https://github.com/Rick21-bit/flutter-simplecounter) | first flutter app |
| [flutter-vim](https://github.com/Rick21-bit/flutter-vim) | vim-like flutter ui |
| [learningflutter](https://github.com/Rick21-bit/learningflutter) | flutter learning collection |

## 2023 projects

| project | what it does |
|--------|-------------|
| [learningpromptengineering](https://github.com/Rick21-bit/learningpromptengineering) | prompt engineering notes |
| [sloppyjs](https://github.com/Rick21-bit/sloppyjs) | flappy bird style game |
| [thegoat](https://github.com/Rick21-bit/thegoat) | messi tribute site |
| [nodejs-learning](https://github.com/Rick21-bit/nodejs-learning) | node.js experiments |
| [typescript-learning](https://github.com/Rick21-bit/typescript-learning) | typescript practice |
| [task-cli](https://github.com/Rick21-bit/task-cli) | command line task manager |
| [url-shortener](https://github.com/Rick21-bit/url-shortener) | url shortener prototype |
| [event-bus](https://github.com/Rick21-bit/event-bus) | node event bus |
| [servermanagement](https://github.com/Rick21-bit/servermanagement) | server setup scripts |
| [chatgptapifinder](https://github.com/Rick21-bit/chatgptapifinder) | chatgpt integration finder |
| [derejekebdebio](https://github.com/Rick21-bit/derejekebdebio) | personal project archive |
...
| [weather-dashboard](https://github.com/Rick21-bit/weather-dashboard) | weather dashboard |
| [habit-tracker](https://github.com/Rick21-bit/habit-tracker) | habit tracker app |
| [bill-splitter](https://github.com/Rick21-bit/bill-splitter) | bill splitting tool |
| [password-maker](https://github.com/Rick21-bit/password-maker) | password generator |
| [markdown-notes](https://github.com/Rick21-bit/markdown-notes) | markdown notes app |
| [pomodoro-timer](https://github.com/Rick21-bit/pomodoro-timer) | pomodoro timer |
| [recipe-finder](https://github.com/Rick21-bit/recipe-finder) | recipe finder |
| [bookshelf](https://github.com/Rick21-bit/bookshelf) | book tracker |
| [focus-todo](https://github.com/Rick21-bit/focus-todo) | focused todo app |
...
| [spamfighter](https://github.com/Rick21-bit/spamfighter) | spam classifiers |
| [pingpon](https://github.com/Rick21-bit/pingpon) | genetic algorithm ping pong ai |
| [cai](https://github.com/Rick21-bit/cai) | c tensorflow inference demo |
| [betika-automation](https://github.com/Rick21-bit/betika-automation) | betting dashboard scraper |
| [n8n-automation](https://github.com/Rick21-bit/n8n-automation) | n8n workflow examples |
| [studypal](https://github.com/Rick21-bit/studypal) | ai study planner + pomodoro |
| [carbontally](https://github.com/Rick21-bit/carbontally) | carbon footprint tracker |
| [devsync](https://github.com/Rick21-bit/devsync) | async standup board |
| [jobhive](https://github.com/Rick21-bit/jobhive) | job application tracker |
| [askdoc](https://github.com/Rick21-bit/askdoc) | health context checker |

## 2026 projects

| project | what it does |
|--------|-------------|
| [hermes](https://github.com/Rick21-bit/hermes) | delivery route optimizer |
